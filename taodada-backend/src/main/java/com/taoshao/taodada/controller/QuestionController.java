...
import com.taoshao.taodada.manager.AiManager;
import com.taoshao.taodada.model.dto.question.*;
...
import com.taoshao.taodada.model.enums.UserRoleEnum;
...
public class QuestionController {
    ...
    public SseEmitter aiGenerateQuestionSSE(AiGenerateQuestionRequest aiGenerateQuestionRequest) {
        ...
        // 定义 原子类整数，异步多线程。
        // 左括号计数器，除了默认值外，当回归为 0 时，表示左括号 = 右括号，可以截取
