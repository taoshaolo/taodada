package com.taoshao.taodada.service.impl;
...
import com.taoshao.taodada.constant.CommonConstant;
import com.taoshao.taodada.exception.ThrowUtils;
import com.taoshao.taodada.mapper.AppMapper;
import com.taoshao.taodada.model.dto.app.AppQueryRequest;
import com.taoshao.taodada.model.entity.App;
import com.taoshao.taodada.model.entity.User;
import com.taoshao.taodada.model.enums.AppScoringStrategyEnum;
import com.taoshao.taodada.model.enums.AppTypeEnum;
import com.taoshao.taodada.model.enums.ReviewStatusEnum;
import com.taoshao.taodada.model.vo.AppVO;
...
import com.taoshao.taodada.utils.SqlUtils;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (StringUtils.isNotBlank(appName)) {
            ThrowUtils.throwIf(appName.length() > 40, ErrorCode.PARAMS_ERROR, "应用名称要小于 40");
        }
        if (StringUtils.isNotBlank(appDesc)) {
            ThrowUtils.throwIf(appName.length() > 500, ErrorCode.PARAMS_ERROR, "应用描述要小于 500");
        }
        if (reviewStatus != null) {
            ReviewStatusEnum reviewStatusEnum = ReviewStatusEnum.getEnumByValue(reviewStatus);
            ThrowUtils.throwIf(reviewStatusEnum == null, ErrorCode.PARAMS_ERROR, "应用状态非法");
        }
